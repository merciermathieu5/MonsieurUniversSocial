...
const figures = racine.querySelectorAll(".fnc__fiche .fnc__figure");
verifier("six documents illustrés, un par fiche", figures.length === 6, figures.length);
verifier("la réserve cachée est vidée", !racine.querySelector(".fnc__medias"));
verifier("chaque figure porte son crédit ou un repli",
  !!fiches[0].querySelector(".fnc__figure figcaption"));
